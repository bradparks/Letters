...
public  class ExampleLetters_drawToScreen_62__Fun extends haxe.lang.Function
{
	public    ExampleLetters_drawToScreen_62__Fun(haxe.root.Array<haxe.root.Array> path)
	{
		super(1, 0);
		this.path = path;
	}
		...
		haxe.root.Array<java.lang.Object> p = null;
		{
			...
			while (( _g < this.path.__get(0).length ))
			{
				...
				p = ((haxe.root.Array<java.lang.Object>) (haxe.lang.Runtime.getField(cmd, "v0", true)) );
				{
					...
					{
						java.lang.String __temp_svar152 = (_g1);
						boolean __temp_executeDef153 = true;
						switch (__temp_svar152.hashCode())
						{
							case 77:
							{
								if (__temp_svar152.equals("M")) 
								{
