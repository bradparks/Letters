...
public  class LetterResource extends haxe.lang.HxObject
{
	public    LetterResource(haxe.lang.EmptyObject empty)
	{
		{
		}
	...
	{
		LetterResource.__hx_ctor_letters_LetterResource(this);
	}
	
	
	public static   void __hx_ctor_letters_LetterResource(LetterResource __temp_me19)
	{
		{
			__temp_me19.letters = new haxe.ds.StringMap<Path>();
		}
		
	}
	
	
	public static   double preAdjustX(java.lang.String str)
	{
		{
			java.lang.String __temp_svar172 = (str);
			int __temp_hash174 = __temp_svar172.hashCode();
			boolean __temp_executeDef173 = true;
			switch (__temp_hash174)
			{
				case 115:case 105:
				{
					if (( (( ( __temp_hash174 == 115 ) && __temp_svar172.equals("s") )) || __temp_svar172.equals("i") )) 
					{
	...
	public static   double postAdjustX(java.lang.String str)
	{
		{
			java.lang.String __temp_svar175 = (str);
			int __temp_hash177 = __temp_svar175.hashCode();
			boolean __temp_executeDef176 = true;
			switch (__temp_hash177)
			{
				case 106:case 105:
				{
					if (( (( ( __temp_hash177 == 106 ) && __temp_svar175.equals("j") )) || __temp_svar175.equals("i") )) 
					{
	...
	public static   double verticalAdj(java.lang.String str)
	{
		{
			java.lang.String __temp_svar178 = (str);
			boolean __temp_executeDef179 = true;
			switch (__temp_svar178.hashCode())
			{
				case 103:
				{
					if (__temp_svar178.equals("g")) 
					{
	...
	{
		return new LetterResource(((haxe.lang.EmptyObject) (haxe.lang.EmptyObject.EMPTY) ));
	}
	...
	public  haxe.ds.StringMap<Path> letters;
	
	public final   Path getLetter(java.lang.String str)
	{
		if (this.letters.exists(str)) 
		{
		 ...
		 else 
		{
			...
			{
				java.lang.String __temp_svar167 = (str);
				boolean __temp_executeDef168 = true;
				switch (__temp_svar167.hashCode())
				{
					case 97:
					{
						if (__temp_svar167.equals("a")) 
						{
			...
			Path patha = new Path(haxe.lang.Runtime.toString(aLetter));
	...
	{
		{
			...
			switch (field.hashCode())
			{
				case 68378893:
				{
					if (field.equals("letters")) 
					{
						__temp_executeDef169 = false;
						this.letters = ((haxe.ds.StringMap<Path>) (value) );
						return value;
					}
	...
	{
		{
			boolean __temp_executeDef170 = true;
			switch (field.hashCode())
			{
				case 589842204:
				{
					...
					{
						__temp_executeDef170 = false;
						return ((haxe.lang.Function) (new haxe.lang.Closure(((java.lang.Object) (this) ), haxe.lang.Runtime.toString("getLetter"))) );
					}
