...
public  class LetterResource extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_letters_LetterResource(LetterResource __temp_me17)
	{
		{
			__temp_me17.letters = new haxe.ds.StringMap<Path>();
		}
	...
	{
		{
			java.lang.String __temp_svar159 = (str);
			boolean __temp_executeDef160 = true;
			switch (__temp_svar159.hashCode())
			{
				case 105:
				{
					if (__temp_svar159.equals("i")) 
					{
	...
	{
		{
			java.lang.String __temp_svar161 = (str);
			boolean __temp_executeDef162 = true;
			switch (__temp_svar161.hashCode())
			{
				case 105:
				{
					if (__temp_svar161.equals("i")) 
					{
	...
	{
		{
			java.lang.String __temp_svar163 = (str);
			boolean __temp_executeDef164 = true;
			switch (__temp_svar163.hashCode())
			{
				case 103:
				{
					if (__temp_svar163.equals("g")) 
					{
	...
	public final   Path getLetter(java.lang.String str)
	{
		 ...
		 else 
		{
			...
			{
				java.lang.String __temp_svar154 = (str);
				boolean __temp_executeDef155 = true;
				switch (__temp_svar154.hashCode())
				{
					case 97:
					{
						if (__temp_svar154.equals("a")) 
						{
