...
letters.ExampleLetters = function() {
	var path = letters.Path.generateVectorText("hi my name is justin and i live in bath a small city in the south west of the uk",100.,50.,.7,300.,22.,null,letters.Path.rainbowPencilHighlight,null);
